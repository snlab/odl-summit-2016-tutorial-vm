...
sudo echo 'sudo mn --controller=remote,ip=127.0.0.1 --mac --custom=/home/vagrant/utils/Maple_Topo_Scripts/exampletopo.py --topo=mytopo --switch=ovs,protocols=OpenFlow13' > /usr/local/bin/start_maple_mininet
